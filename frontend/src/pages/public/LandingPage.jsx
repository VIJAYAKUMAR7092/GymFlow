    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <nav className="bg-white shadow-md">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <h1 className="text-3xl font-bold text-blue-700">GymFlow</h1>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <p className="mt-6 text-lg text-gray-600">
            Manage members, attendance, subscriptions, payments, reports and
            much more from one dashboard.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-20">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <p className="mt-3 text-gray-500">Manage unlimited gym members.</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <p className="mt-3 text-gray-500">Track every payment instantly.</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <p className="mt-3 text-gray-500">Beautiful dashboard analytics.</p>
          </div>

          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            <FaDumbbell className="text-5xl text-orange-500 mx-auto mb-4" />

            <h3 className="font-bold text-xl">Membership</h3>

            <p className="mt-3 text-gray-500">Flexible membership plans.</p>
          </div>
        </div>
      </section>
      {/* Pricing */}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="border rounded-2xl shadow-lg p-8 text-center hover:shadow-2xl transition">
              ...
              <p className="text-5xl font-bold my-6">₹999</p>
            ...
            <div className="border-2 border-blue-600 rounded-2xl shadow-2xl p-8 text-center scale-105">
              ...
              <p className="text-5xl font-bold my-6">₹1999</p>
            ...
            <div className="border rounded-2xl shadow-lg p-8 text-center hover:shadow-2xl transition">
              ...
              <p className="text-5xl font-bold my-6">Custom</p>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-6">Why GymFlow?</h2>

          <p className="text-gray-600 text-lg max-w-4xl mx-auto leading-8">
            GymFlow is a complete cloud-based Gym Management System designed to
            simplify your daily operations. Manage memberships, attendance,
            subscriptions, payments and reports from one beautiful dashboard.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 mb-10">
            Need a demo or custom pricing? Our team is ready to help.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="shadow-lg rounded-2xl p-8">
              ...
              <p className="text-gray-600">vijayakumar709202@gmail.com</p>
            </div>

            <div className="shadow-lg rounded-2xl p-8">
              <h3 className="font-bold text-xl mb-3">📞 Phone</h3>

              <p className="text-gray-600">+91 7092025262</p>
            </div>
      ...
      <footer className="bg-slate-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
          <div>
            <h2 className="text-3xl font-bold">GymFlow</h2>

            <p className="text-gray-400 mt-2">Smart Gym Management Software</p>
          </div>
      ...
      <footer className="bg-slate-900 text-white py-10 text-center">
        <h2 className="text-2xl font-bold">GymFlow</h2>
